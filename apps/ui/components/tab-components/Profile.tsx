      ...
      {isGrid ? (
        <div className="space-y-5 flex flex-col justify-center -ml-[5%]">
          ...
          <div className="text-center">
            <h3 className="text-2xl font-semibold capitalize">Williams eni</h3>
            <p className="text-sm">
          ...
          <div className="lg:w-1/4 mx-auto space-y-2 w-3/4 md:w-1/2">
            <div className="drag-shadow p-1">
              ...
              >
                ...
                <ShareNetwork size={20} className="font-semibold" />
              </button>
            </div>

            <p className="text-center w-full text-gray text-xs">Tab to share</p>
          </div>
        </div>
      ) : (
          ...
          <div className="drag-shadow p-1">
            ...
            >
              ...
              <div className="flex gap-1 items-center">
                ...
                <ShareNetwork size={15} className="font-semibold" />
                <Image
